...
Assetsで画像をアップロードしたら、Workdspaceが図4.2のようにファイル名が表示されているならば大丈夫です。
//image[02][ファイル名のリスト][scale=0.7]
...
画像をアップロードし、Workdspaceのパネルを確認すると図4.3のようになっているかと思います。
//image[04][管理画面の完成][scale=0.7]
